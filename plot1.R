...
## and plots a histogram of Global Active Power on two dates (2/1/2007 and 2/2/2007)
...
hist(as.numeric(power$Global_active_power), col="red", breaks=10, xlab="Global Active Power (kilowatts)", main="Global Active Power")
dev.off()